...
export const translations = {
  ja: {
    ...
    profile: {
      ...
      newPasswordPlaceholder: '8文字以上で入力',
    ...
    security: {
      ...
      newPasswordPlaceholder: '8文字以上で入力',
      confirmPasswordPlaceholder: 'もう一度入力',
      googleAccountNote: 'Googleでログインしています',
      createPasswordDesc: 'パスワードを設定すると、メールアドレスとパスワードでもログインできるようになります',
      passwordMinLength: '※ パスワードは8文字以上で設定してください',
      creating: '作成中...',
      changing: '変更中...',
      passwordCreated: 'パスワードを作成しました',
      passwordChanged: 'パスワードを変更しました',
      createPasswordError: 'パスワードの作成に失敗しました',
    ...
    privacy: {
      ...
      accountDeletionDesc: 'アカウントを完全に削除します',
      dangerZone: '危険な操作',
      deleteAccount: 'アカウントを削除',
      deleteAccountWarning: 'この操作は取り消せません。30日間の猶予期間後、すべてのデータが完全に削除されます。',
      whatWillBeDeleted: '削除されるデータ',
      allProjects: 'すべてのプロジェクト',
      allRevenues: 'すべての売上データ',
      allEvents: 'すべてのカレンダーイベント',
      allSettings: 'すべての設定',
      allSessions: 'すべてのセッション',
      gracePeriod: '削除猶予期間',
      gracePeriodDesc: '削除リクエスト後30日間は復旧可能です。猶予期間中はログインできません。',
      confirmDeletion: 'アカウント削除の確認',
      confirmDeletionDesc: '本当にアカウントを削除しますか？この操作を実行するには、パスワードを入力してください。',
      enterPassword: 'パスワードを入力',
      passwordPlaceholder: 'パスワード',
      typeDelete: '「削除」と入力してください',
      typeDeletePlaceholder: '削除',
      deleteConfirmText: '削除',
      cancel: 'キャンセル',
      confirmDelete: '削除を確定',
      deleting: '削除中...',
      deleteSuccess: 'アカウント削除リクエストを送信しました',
      deleteError: 'アカウント削除に失敗しました',
      passwordRequired: 'パスワードを入力してください',
      confirmTextRequired: '「削除」と入力してください',
      passwordIncorrect: 'パスワードが正しくありません',

      // 削除リクエスト状態
      pendingDeletionTitle: '削除リクエスト進行中',
      pendingDeletionMessage: 'アカウント削除リクエストが進行中です。猶予期間中はキャンセルできます。',
      scheduledDeletionDate: '削除予定日',
      cancelDeletion: '削除をキャンセル',
      cancelDeletionConfirm: '本当に削除をキャンセルしますか？',
      cancelling: 'キャンセル中...',
      cancelSuccess: '削除リクエストをキャンセルしました',
  ...
  en: {
    ...
    security: {
      ...
      googleAccountNote: 'Signed in with Google',
      createPasswordDesc: 'Set a password to enable email/password login in addition to Google sign-in',
      passwordMinLength: '* Password must be at least 8 characters',
      creating: 'Creating...',
      changing: 'Changing...',
      passwordCreated: 'Password created successfully',
      passwordChanged: 'Password changed successfully',
      createPasswordError: 'Failed to create password',
    ...
    privacy: {
      ...
      accountDeletionDesc: 'Permanently delete your account',
      dangerZone: 'Danger Zone',
      deleteAccount: 'Delete Account',
      deleteAccountWarning: 'This action cannot be undone. After a 30-day grace period, all data will be permanently deleted.',
      whatWillBeDeleted: 'What will be deleted',
      allProjects: 'All projects',
      allRevenues: 'All revenue data',
      allEvents: 'All calendar events',
      allSettings: 'All settings',
      allSessions: 'All sessions',
      gracePeriod: 'Grace Period',
      gracePeriodDesc: 'You can recover your account within 30 days after deletion request. You cannot login during the grace period.',
      confirmDeletion: 'Confirm Account Deletion',
      confirmDeletionDesc: 'Are you sure you want to delete your account? Please enter your password to proceed.',
      ...
      deleting: 'Deleting...',
      deleteSuccess: 'Account deletion request has been submitted',
      deleteError: 'Failed to delete account',
      passwordRequired: 'Please enter your password',
      confirmTextRequired: 'Please type "DELETE" to confirm',
      passwordIncorrect: 'Incorrect password',

      // Deletion request status
      pendingDeletionTitle: 'Deletion Request Pending',
      pendingDeletionMessage: 'Your account deletion request is pending. You can cancel it during the grace period.',
      scheduledDeletionDate: 'Scheduled Deletion Date',
      cancelDeletion: 'Cancel Deletion',
      cancelDeletionConfirm: 'Are you sure you want to cancel the deletion request?',
      cancelling: 'Cancelling...',
      cancelSuccess: 'Deletion request has been cancelled',
